    ...
    <script type="text/javascript">
    	$(document).ready(function(){			
			...
			$("#addTrailer").click(function(){
				...
				if(name==""||name==null||introduce==""||introduce==null||thumb_path==""||thumb_path==null||standard_video_path==""||standard_video_path==null||high_video_path==""||high_video_path==null){
...
<div class="container-fluid" style="padding: 15px;">
	...
	<div class="row" style="margin-top: 15px;">
		<!-- 表单开始 -->
		<form id="addForm" method="post" enctype="multipart/form-data" action="/bendi/thinkmuyin/index.php/Admin/Trailer/addDo/p/<?php echo ($pageNow); ?>/where/<?php echo ($where); ?>/order/<?php echo ($order); ?>" style="margin: 0px; padding: 0px;">
		...
		<div class="col-xs-6 sk_col" style="padding-right: 5px;">
			<div class="sk_option_back" style="border-top-color: #3C8DBC;">
				...
				<div class="row" style="height:30px; line-height:30px;border-bottom: 1px dotted #EEEEEE; margin-bottom: 15px;">
					<div class="col-xs-6 sk_col">添加一个宣传片</div>
					<div class="col-xs-6 sk_col text-right" id="alert"></div>
				</div>
				
				<div class="form-group">
					<label for="name">宣传片名称</label>
					<input type="text" class="form-control sk_input" id="name" name="name" maxlength="50" placeholder="小蜗牛传媒第一次媒体宣传">
				</div>
				...
				<div class="form-group">
					...
					<select class="form-control sk_input" id="locally" name="locally">
						<option value="1" selected="selected">本地服务器</option>
						<option value="0">第三方支持</option>
					</select>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control sk_input" id="standard_video_path" name="standard_video_path" maxlength="200">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control sk_input" id="high_video_path" name="high_video_path" maxlength="200">
				</div>
				<span class="help-block sk_help_block">
					<span class="glyphicon glyphicon-info-sign"></span><br />
					服务器本地存放视频文件时请确保文件真实存在<br />
				...
				<div class="form-group">
					<a id="addTrailer" class="btn-primary sk_submitbtn" href="#"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;添加 add</a>
					<a id="back" class="btn-warning sk_submitbtn" href="/bendi/thinkmuyin/index.php/Admin/Trailer/index/p/<?php echo ($pageNow); ?>/where/<?php echo ($where); ?>/order/<?php echo ($order); ?>"><span class="glyphicon glyphicon-share"></span>&nbsp;&nbsp;放弃 back</a>
				</div>
		...
		<!-- add right-->
		<div class="col-xs-6 sk_col" style="padding-left: 5px; display: none;" id="addRight">
			<div class="sk_option_back" style="border-top-color: #3C8DBC;">123
			</div>
		</div>
