	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-xs-6 sk_col" style="padding-right: 10px;">
			<div class="sk_option_back" style="border-top-color: #00A65A;">
				...
				<div>
				<form id="edit_form" method="post" action="/thinkmuyin/index.php/Admin/Province/editDo/p/<?php echo ($p); ?>/order/<?php echo ($order); ?>" style="margin: 0px; padding: 0px;">
					...
					<div class="form-group" style="margin-top: 15px;">
  					...
  					<div>
	 					...
	 					<div class="sk_back_btn_gp" style="float: left; margin-left: 5px;">
	 						...
	 						<a class="sk_back_btn_ipt" href="/thinkmuyin/index.php/Admin/Province/index/p/<?php echo ($p); ?>/order/<?php echo ($order); ?>">放弃&nbsp;back</a>
	 					</div>
	 					<div style="clear: both;"></div>
  					</div>
				</form>
