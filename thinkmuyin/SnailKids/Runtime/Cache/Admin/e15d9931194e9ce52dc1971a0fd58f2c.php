    ...
    <script type="text/javascript">
    	$(document).ready(function(){			
			...
			$("#addLink").click(function(){		
				...
				var cover_path = $("#cover_path").val();
				var svideo_path = $("#svideo_path").val();
				var hvideo_path = $("#hvideo_path").val();
				if(title==""||title==null||introduce==""||introduce==null||duration==""||duration==null||cover_path==""||cover_path==null||svideo_path==""||svideo_path==null||hvideo_path==""||hvideo_path==null){
...
<div class="container-fluid" style="padding: 15px;">
	...
	<div class="row" style="margin-top: 15px;">
		<!-- 表单开始 -->
		<form id="addForm" method="post" enctype="multipart/form-data" action="/snailkids.php/Admin/Video/addDo/p/<?php echo ($pageNow); ?>/where/<?php echo ($where); ?>/order/<?php echo ($order); ?>" style="margin: 0px; padding: 0px;">
		...
		<div class="col-xs-6 sk_col" style="padding-right: 5px;">
			<div class="sk_option_back" style="border-top-color: #3C8DBC;">
				...
				<div class="row" style="height:30px; line-height:30px;border-bottom: 1px dotted #EEEEEE; margin-bottom: 15px;">
					<div class="col-xs-6 sk_col">添加一个视频</div>
					<div class="col-xs-6 sk_col text-right" id="alert"></div>
				</div>
				
				<div class="form-group">
					<label for="title">视频标题</label>
					<input type="text" class="form-control sk_input" id="title" name="title" maxlength="50" placeholder="人生第一次领悟">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control sk_input" id="duration" name="duration" maxlength="50" placeholder="00:05:30">
				</div>
				
				<div class="form-group">
					<label for="theme_id">所属主题</label>
					<select class="form-control sk_input" id="theme_id" name="theme_id">
						<?php if(is_array($themeData)): foreach($themeData as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
					</select>
				</div>
		...
		<div class="col-xs-6 sk_col" style="padding-left: 5px;">
			<div class="sk_option_back" style="border-top-color: #3C8DBC;">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control sk_input" id="svideo_path" name="svideo_path" maxlength="200">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control sk_input" id="hvideo_path" name="hvideo_path" maxlength="200">
				</div>
				<span class="help-block sk_help_block">
					<span class="glyphicon glyphicon-info-sign"></span><br />
					服务器本地存放视频文件时请确保文件真实存在<br />
