	...
	<div class="row" style="margin-top: 100px;">
		...
		<div class="col-xs-4 sk_col">
			...
			<div style="font-size: 16px; height: 20px; line-height: 20px;">
				<span style="color: #00A65A;" class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Ok! operation was successful.
			</div>
			<div style="margin-top: 15px;">
				<p style="color: #00A65A; font-weight: bold;"><?php echo($message); ?></p>
				<p>
			...
			<?php }else{?>
			<div style="font-size: 16px; height: 20px; line-height: 20px;">
				<span style="color: #DD4B39;" class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Oops! Something went wrong.
			</div>
			<div style="margin-top: 15px;">
